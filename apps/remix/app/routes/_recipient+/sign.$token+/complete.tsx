      ...
      >
        ...
        >
          ...
          >
            ...
            {/* WAF eSign: upstream's `DocumentShareButton` was removed from here.
                It published the signer's name and signature image to an
                unauthenticated /share/<slug> URL and offered to post that link
                to X alongside a hardcoded "@documenso" mention. The component
                and the /share routes are left untouched — the signing
                certificate's QR code depends on those routes. */}
