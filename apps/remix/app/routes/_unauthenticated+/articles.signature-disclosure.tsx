  ...
  return (
    <div>
      <article className="prose dark:prose-invert">
        ...
        <p>
          <Trans>
            Thank you for using WAF eSign to perform your electronic document signing. The purpose of this disclosure is
        ...
        <p>
          <Trans>
            By proceeding to use the electronic signature service provided by WAF eSign, you affirm that you have read
